...
class FormatSpec extends WordSpec with Matchers {
  ...
  "Format" should {
    ...
    "support primitives types" when {
      ...
      "Traversable" in {
        Formatting[JValue, JObject] { __ => (__ \ "n").format[Traversable[String]] }.validate(JObject("n" -> JArray(List(JString("foo"))))).toOption.get.toSeq shouldBe(Seq("foo"))
        Formatting[JValue, JObject] { __ => (__ \ "n").format[Traversable[Int]] }.validate(JObject("n" -> JArray(List(JInt(1), JInt(2), JInt(3))))).toOption.get.toSeq shouldBe(Seq(1, 2, 3))
      ...
      "Array" in {
        Formatting[JValue, JObject] { __ => (__ \ "n").format[Array[String]] }.validate(JObject("n" -> JArray(List(JString("foo"))))).toOption.get.toSeq shouldBe(Seq("foo"))
        Formatting[JValue, JObject] { __ => (__ \ "n").format[Array[Int]] }.validate(JObject("n" -> JArray(List(JInt(1), JInt(2), JInt(3))))).toOption.get.toSeq shouldBe(Seq(1, 2, 3))
      ...
      "Seq" in {
        Formatting[JValue, JObject] { __ => (__ \ "n").format[Seq[String]] }.validate(JObject("n" -> JArray(List(JString("foo"))))).toOption.get shouldBe(Seq("foo"))
        Formatting[JValue, JObject] { __ => (__ \ "n").format[Seq[Int]] }.validate(JObject("n" -> JArray(List(JInt(1), JInt(2), JInt(3))))).toOption.get shouldBe(Seq(1, 2, 3))
