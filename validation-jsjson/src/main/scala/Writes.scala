  ...
  implicit def jsonMonoid = new Monoid[js.Dynamic] {
    ...
    def combine(a1: js.Dynamic, a2: js.Dynamic): js.Dynamic = 
      js.Dictionary[js.Dynamic](
        (
          a1.asInstanceOf[js.Dictionary[js.Dynamic]] ++
          a2.asInstanceOf[js.Dictionary[js.Dynamic]]
        ).toSeq: _*
...
object Writes extends DefaultWrites with DefaultMonoids with GenericWrites[js.Dynamic] {
  ...
  implicit def failureW(implicit w: WriteLike[(Path, Seq[ValidationError]), js.Dynamic]) =
  ...
  implicit val longW = Write[Long, js.Dynamic] { l => (l: js.Any).asInstanceOf[js.Dynamic] }
  ...
  def optionW[I, J](r: => WriteLike[I, J])(implicit w: Path => WriteLike[J, js.Dynamic]): Path => Write[Option[I], js.Dynamic] =
    super.optionW[I, J, js.Dynamic](r, js.Dynamic.literal())

  implicit def optionW[I](implicit w: Path => WriteLike[I, js.Dynamic]): Path => Write[Option[I], js.Dynamic] =
  ...
  implicit def writeJson[I](path: Path)(implicit w: WriteLike[I, js.Dynamic]): Write[I, js.Dynamic] = Write { i =>
    path match {
