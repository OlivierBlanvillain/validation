...
lazy val validationJVM = aggregate("validationJVM", coreJVM, formJVM, delimitedJVM, json4sJVM, experimentalJVM, `validation-playjson`, `validation-xml`)
...
lazy val `validation-docs` = project
  ...
  .dependsOn(coreJVM, formJVM, delimitedJVM, json4sJVM, experimentalJVM, `validation-playjson`, `validation-xml`)
