...
object Write {
  ...
  implicit def functionalInvariantSyntaxWriteContravariant[O](implicit m: Monoid[O]): SyntaxCombine[Write[?, O]] =
  ...
  implicit def fboWrite[I, O : Monoid](w: Write[I, O])(implicit fcb: SyntaxCombine[Write[?, O]]):
