...
implicit val creatureRule: Rules[JsValue, Creature] = From[JsValue] { __ =>
...
val r: Rule[JsValue, Seq[(String, String)]] = From[JsValue] { __ =>
  ...
  val tupleR[JsValue, (String, String)] = Rule.fromMapping[JsValue, (String, String)] {
...
val rule: Rules[JsValue, A] = From[JsValue] { __ =>
  import jto.validation.playjson.Rules._
